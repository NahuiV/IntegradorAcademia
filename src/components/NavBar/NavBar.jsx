  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <Divider />
        <List>
          <ListItem button key={'Productos'} onClick={()=>{navigate("/Products");}}>
            <ListItemIcon>
                <InventoryIcon />
              </ListItemIcon>
          ...
          <ListItem button key={'Proveedores'} onClick={()=>{navigate("/Providers");}}>
            <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
          ...
          <ListItem button key={'Empleados'} onClick={()=>{navigate("/Employes");}}>
          <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
